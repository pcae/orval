 ...
 */
export declare const listPets: (params: ListPetsParams, version?: number, options?: SecondParameter<typeof customInstance>, signal?: AbortSignal) => Promise<Pets>;
 ...
 */
export declare const createPets: (createPetsBody: CreatePetsBody, params: CreatePetsParams, version?: number, options?: SecondParameter<typeof customInstance>) => Promise<Pet>;
 ...
 */
export declare const showPetById: (petId: string, version?: number, options?: SecondParameter<typeof customInstance>, signal?: AbortSignal) => Promise<Pet>;
 ...
 */
export declare const healthCheck: (version?: number, options?: SecondParameter<typeof customInstance>, signal?: AbortSignal) => Promise<string>;
